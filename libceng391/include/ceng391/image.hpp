...
public:
        ...
        float * gaussian_kernel(float sigma,int size);
        void gaussian_smooth_buffer(int n,uchar* buffer,int filter_size,float sigma);

        void smooth_x(float sigma);
        void smooth_y(float sigma);
        void smooth (float sigma);

        void kernel_buffer(int n, uchar* buffer);
        short *kernel_deriv_buffer(int n, uchar* buffer);
        short *deriv_x();
        short *deriv_y();

        void rotate(float theta, Image *img);
